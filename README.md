# Ultimate Tic-Tac-Toe AlphaZero (ver2.1)
...
- **パラメータ数**: 約1.2M
- **最適化**: Adam optimizer, 動的学習率, L2正則化 (1e-4)
- **学習率スケジューラ**: エポック50で0.75倍, エポック80で0.5倍
